...
import sys
sys.path.append("/home/nur/AV/CARLA_0.9.13/PythonAPI/carla/dist/carla-0.9.13-py3.7-linux-x86_64.egg")
...
def define_sensors():
  ...
  if args.tm:
    ...
    list_sensor_specs.append(sensors07)
    list_sensor_specs.append(sensors08)
    list_sensor_specs.append(sensors09)
    list_sensor_specs.append(sensors10)
